        ...
        <div className="flex justify-center items-center w-full h-full px-4 md:px-10">
          <div className={theme.layout.container}>
            ...
            <div className='text-center md:text-start space-y-2 mb-10'>
              <p className={theme.typography.heading.primary}>{config.forms.twoFA.title}</p>
              <p className={theme.typography.heading.secondary}>{config.forms.twoFA.description}</p>
            </div>
            <hr
