					...
					<div className={theme.layout.container}>
						...
						<div className="text-center md:text-start space-y-2 mb-10">
							<p className={theme.typography.heading.primary}>
								{config.forms.signup.title}
							</p>
							<p className={theme.typography.heading.secondary}>
								{config.forms.signup.description}
							</p>
						</div>
						<hr
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<div className={theme.components.form.fieldSpacing}>
									...
									<Input
										...
										type="text"
										placeholder={
											config.forms.signup.fields.firstName.placeholder
										}
								...
								<div className={theme.components.form.fieldSpacing}>
									...
									<Input
										...
										type="text"
										placeholder={
											config.forms.signup.fields.lastName.placeholder
										}
