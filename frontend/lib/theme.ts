...
export const theme = {
  colors: {
    ...
    button: {
      primary: {
        background: 'bg-gradient-to-r from-[#0a1d12] via-[#15412e] to-[#247050]',
  ...
  typography: {
    ...
    brand: {
      ...
      heroSecondary: 'text-4xl md:text-5xl font-extralight text-[#c7dfd4] leading-tight tracking-tight',
    },
  },
...
export const getLinkStyles = (withHover: boolean = true) => {
  return withHover 
